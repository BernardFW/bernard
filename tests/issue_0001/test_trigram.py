...
from bernard.trigram import Matcher, Trigram, make_trigrams, make_words, normalize
...
def test_make_words():
    assert make_words("aimes tu les saucisses") == ["aimes", "tu", "les", "saucisses"]
...
def test_similarity():
    ...
    sim = Trigram("Aimes-tu les saucisses ?") % Trigram("Aimes-tu les bananes ?")
